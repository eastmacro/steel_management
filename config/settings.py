...
#STATIC_ROOT = '/Users/huozhiquan/steel_management/static/'
...
SECRET_KEY = 'mp87%ey5ry!#(fa&$^(a83s^a95*$p@!9kndx@4(_)f7_8osd='
...
SESSION_COOKIE_AGE = 10 * 60  # 10min
...
DATABASE_ROUTERS = ['utils.db.router.DBRouter']
